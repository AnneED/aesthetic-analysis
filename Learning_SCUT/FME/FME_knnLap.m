...
save('results_FME_50knn_vgg7.mat', 'MAE', 'PC', 'RMSE', 'E');
...
save('results_FME_70knn_vgg7.mat', 'MAE', 'PC', 'RMSE', 'E');
...
save('results_FME_90knn_vgg7.mat', 'MAE', 'PC', 'RMSE', 'E');
...
%% Results
load('results_FME_50knn_vgg7.mat');
...
load('results_FME_90knn_vgg7.mat');
[mae, idx] = min(mean(MAE));
mae
rmse = mean(RMSE(:, idx))
pc = mean(PC(:, idx))
