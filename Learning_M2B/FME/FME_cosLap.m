...
% FME 						
% The Laplacian is based on cosine feature similarity (with 10 neighbors) + score similarity
...
save('results_FME_cos_eM2B.mat', 'MAE', 'PC', 'RMSE');
...
save('results_FME_cos_wM2B.mat', 'MAE', 'PC', 'RMSE');
...
save('results_FME_cos_bM2B.mat', 'MAE', 'PC', 'RMSE');
