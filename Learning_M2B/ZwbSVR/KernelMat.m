function Ker = KernelMat(X, T0) 
% X: training matrix. Samples are columns and rows are features.
% T0: parameter controlling the width of the Gaussian kernel function.
